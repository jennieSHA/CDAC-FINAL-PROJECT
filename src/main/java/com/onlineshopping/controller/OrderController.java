...
public class OrderController {
	...
	@GetMapping("/ordersOfLastSevenDays")
	public ResponseEntity findSalesOfLastSevenDays(@RequestParam("startDate") String startDate,@RequestParam("endDate") String endDate)
	{
		return  new ResponseEntity(orderDao.getProductWiseSalesLast7Days(startDate,endDate), HttpStatus.OK);
	}
